<x-layouts::auth :title="__('Registreren')">
    <div class="flex flex-col gap-6">
        <x-auth-header :title="__('Maak een account aan')" :description="__('Vul hieronder je gegevens in om een account aan te maken')" />
        ...
        <div class="space-x-1 rtl:space-x-reverse text-center text-sm text-zinc-400">
            ...
            <flux:link :href="route('login')" wire:navigate class="text-white hover:text-zinc-200">{{ __('Inloggen') }}</flux:link>
        </div>
    </div>
</x-layouts::auth>
